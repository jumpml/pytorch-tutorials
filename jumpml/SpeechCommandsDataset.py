...
import shutil
import glob
from jumpml.utils import get_fileList, generate_background_files
...
DEFAULT_TRANSFORM = torch.nn.Sequential(
            torchaudio.transforms.MelSpectrogram(sample_rate=16000, n_fft=320, hop_length=160, n_mels=64),
            torchaudio.transforms.AmplitudeToDB(stype='power', top_db=80))

class SpeechCommandsData:
    def __init__(self, path='.', train_bs=64, test_bs=256, val_bs=64, n_mels=64):
